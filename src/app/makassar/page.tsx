      ...
      <section className="bg-gradient-to-br from-chery-navy via-chery-navy-2 to-black text-white py-24 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            >
              Your trusted Chery dealership in Sulawesi Selatan. Experience premium automotive service and the latest Chery models.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-text-secondary">
                      Jl. Perintis Kemerdekaan No. 78<br />
                      Makassar, Sulawesi Selatan 90154<br />
                      Indonesia
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+624111234567" className="text-chery-red hover:underline">+62 411 1234 567</a>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:makassar@chery.co.id" className="text-chery-red hover:underline">makassar@chery.co.id</a>
                  </div>
                </div>
              ...
              <div className="mt-8 flex flex-col gap-3">
                <Link href="/contact?dealer=makassar" className="btn-primary inline-flex items-center justify-center">
                  <Phone className="mr-2 h-5 w-5" />
                  Contact This Dealer
                </Link>
                <a
                  href="https://www.google.com/maps?q=-5.1476,119.4327"
                  target="_blank"
            ...
            >
              ...
              <div className="relative h-96 bg-surface-muted rounded-2xl overflow-hidden flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-text-primary font-semibold text-lg">Makassar, Sulawesi Selatan</p>
        ...
        <div className="container-custom text-center">
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact?dealer=makassar" className="btn-white text-lg inline-flex items-center">
                <Phone className="mr-2 h-5 w-5" />
                Contact Us
              </Link>
              <a href="tel:+624111234567" className="btn-outline-light text-lg">
                Call Now
              </a>
            </motion.div>
          </motion.div>
